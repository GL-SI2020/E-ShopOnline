...
public class CartController {
    ...
    @PostMapping("/{email}")
    public ResponseEntity<Cart> mergeCart(@RequestBody Collection<ProductInOrder> productInOrders,@PathVariable  Principal principal) {
    ...
    @GetMapping("{email}")
    public Cart getCart(@PathVariable Principal principal) {
        User user = userService.findOne(principal.getName());
    ...
    public boolean addToCart(@RequestBody ItemForm form,@PathVariable Principal principal) {
